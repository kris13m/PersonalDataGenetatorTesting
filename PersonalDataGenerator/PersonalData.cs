...
public class PersonalData
{
    ...
    public void SetPhoneNumber()
    {
        ...
        // Substring(startIndex, length) splits the phone number into two-digit chunks, which are inserted 
        // into the placeholders {0}, {1}, {2}, and {3}, with spaces in between for formatting.
        this.PhoneNumber = string.Format("{0} {1} {2} {3}",
                                    phone.Substring(0, 2),
                                    phone.Substring(2, 2),
                                    phone.Substring(4, 2),
                                    phone.Substring(6, 2));
